...
namespace Ju.Time
{
	[CustomPropertyDrawer(typeof(TimeSince))]
	public class TimeSinceDrawer : PropertyDrawer
	{
		...
		public override void OnGUI(Rect pos, SerializedProperty prop, GUIContent label)
		{
			...
			{
				EditorGUI.TextField(contentRect, (ServiceCache.Time.Time - prop.FindPropertyRelative("time").floatValue).ToString());
			}
			else
			{
