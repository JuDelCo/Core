...
namespace Ju.Time
{
	[CustomPropertyDrawer(typeof(TimeUntil))]
	public class TimeUntilDrawer : PropertyDrawer
	{
		...
		public override void OnGUI(Rect pos, SerializedProperty prop, GUIContent label)
		{
			...
			{
				EditorGUI.TextField(contentRect, (prop.FindPropertyRelative("time").floatValue - ServiceCache.Time.Time).ToString());
			}
			else
			{
